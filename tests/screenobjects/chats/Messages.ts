...
const SELECTORS_MACOS = {
  ...
  CHAT_MESSAGE_LOCAL:
    '-ios class chain:**/XCUIElementTypeGroup[`label == "message-local"`]',
  CHAT_MESSAGE_REMOTE:
    '-ios class chain:**/XCUIElementTypeGroup[`label == "message-remote"`]',
...
export default class Messages extends UplinkMainScreen {
  ...
  // Click on last message sent or received
