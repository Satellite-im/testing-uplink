...
class FilesScreen extends AppScreen {
  ...
  get crumbText() {
    return $(SELECTORS.CRUMB).$("-ios class chain:**/XCUIElementTypeStaticText[1]")
  }
  ...
  get filesInfoFreeSpaceLabel() {
    return $('ios class chain:**/XCUIElementTypeGroup[`label == "files-info"`]/XCUIElementTypeGroup[1]/XCUIElementTypeStaticText[1]')
  }

  get filesInfoFreeSpaceValue() {
    return $('ios class chain:**/XCUIElementTypeGroup[`label == "files-info"`]/XCUIElementTypeGroup[1]/XCUIElementTypeStaticText[2]')
  }

  get filesInfoTotalSpaceLabel() {
    return $('ios class chain:**/XCUIElementTypeGroup[`label == "files-info"`]/XCUIElementTypeGroup[2]/XCUIElementTypeStaticText[1]')
  }

  get filesInfoTotalSpaceValue() {
    return $('ios class chain:**/XCUIElementTypeGroup[`label == "files-info"`]/XCUIElementTypeGroup[2]/XCUIElementTypeStaticText[2]')
  }
