...
describe("Friends Screen Tests", async () => {
  ...
  xit("Unfriend someone from blocked friends list", async () => {
    ...
    // Get a random user from Blocked list and accept the request
  ...
  // Test skipped since now it is a not existing flow but nice to have in the future
  ...
  xit("Context Menu - Unfriend User", async () => {
    ...
    // Select the only option "Unfriend" from Context Menu
    await FriendsScreen.contextMenuOption[0].click()
