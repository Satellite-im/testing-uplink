...
export const MACOS_BUNDLE_ID = "im.satellite.uplinkChatUserA";
...
export const USER_A_INSTANCE = "userA";
export const USER_B_INSTANCE = "userB";
export const WINDOWS_APP = "\\apps\\uplink.exe";
