...
export const config: WebdriverIO.Config = {
     ...
     */
    specs: [join(process.cwd(), "./tests/specs/reusable-accounts/05-chats-with-one-file.ts")],
    //
    // ============
    // Capabilities
    // ============
    ...
    // configuration files
    //services: [["appium", { command: "appium", port: [4723, 4724], args: { relaxedSecurity: true, log: "./appiumUserA.log" }}]],
