...
exports.config = {
    ...
    capabilities: {
        ...
        a: {
            ...
            capabilities: {
                ...
                "appium:appArguments": "--path " + join(process.cwd(), "\\apps\\ChatUserC"),      
              }
        },
        b: {
            "host": "localhost",
            ...
            capabilities:{
                ...
                "appium:appArguments": "--path " + join(process.cwd(), "\\apps\\ChatUserD"),
            }
        }
    }
    ,
    ...
    services: [["appium", {command: "appium", args: {relaxedSecurity: true, log: "./appium-chat-a.log"}}], ["appium", {command: "appium", args: {relaxedSecurity: true, log: "./appium-chat-b.log"}}]],
